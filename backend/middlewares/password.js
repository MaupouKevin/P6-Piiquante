...
exports.password = (req, res, next) => {
    ...
    if (!passwordSchema.validate(req.body.password)) { 
        ...
        res.status(400, " Mot de passe incorrect : Le mot de passe doit comprendre entre 6 et 30 caractères, au moins une minuscule, au moins une majuscule, un chiffre, pas d'espaces ", {"content-type": "application/json"});
